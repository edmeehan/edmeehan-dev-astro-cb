...
author: Ed Meehan
image:
  src: /blog/crm-forms-in-react.jpg
...
<Image source="/blog/hubspot-screen-shot.png" alt="Hubspot instructions for adding an embedded web form to your website." rounded={true} aspectRatio="horizontal-strip" />
